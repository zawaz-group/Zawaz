  ...
  return (
    <>
      ...
      <main style={{ minHeight: "70vh", maxWidth: "var(--container)", margin: "0 auto", padding: "var(--section-padding)", textAlign: "center" }}>
        ...
        <h1 style={{ fontSize: 28, fontWeight: 800, color: "#1D2820", marginBottom: 12 }}>Favorite</h1>
        <p style={{ color: "#5D695F", fontSize: 15, marginBottom: 32 }}>Nu ai salvat încă niciun produs la favorite.</p>
